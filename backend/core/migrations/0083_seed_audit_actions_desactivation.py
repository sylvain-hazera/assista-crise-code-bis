...
AUDIT_ACTIONS = [
    ("DESACTIVATION", "Désactivation (offre, demande, signalement, équipe, compte)"),
    ("REACTIVATION", "Réactivation (offre, demande, signalement, équipe, compte)"),
]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0082_actif_offer_request_information_team"),
    ]
