"""Référentiel administratif français statique (départements/régions) — une liste fermée,
quasi immuable (le dernier découpage régional date de 2016), pas besoin de la résoudre via
geo.api.gouv.fr à chaque fois comme Commune (variable, ~35000 lignes). Sert à afficher un nom
lisible pour Institution.secteur_nom sans appel réseau pour ces deux niveaux."""
...
DEPARTEMENTS = {
    ...
    "19": "Corrèze", "21": "Côte-d'Or", "22": "Côtes-d'Armor", "23": "Creuse", "24": "Dordogne",
    "25": "Doubs", "26": "Drôme", "27": "Eure", "28": "Eure-et-Loir", "29": "Finistère",
    "2A": "Corse-du-Sud", "2B": "Haute-Corse", "30": "Gard", "31": "Haute-Garonne", "32": "Gers",
...
# (core/views.py). Une mairie/police municipale voit sa commune ; une communauté de communes
# voit son EPCI ; les acteurs départementaux (SDIS, gendarmerie, préfecture, sous-préfecture,
# conseil départemental) voient leur département ; un conseil régional voit sa région. Un type
# non listé retombe sur "commune" (le niveau le plus restrictif), jamais un niveau plus large
# par défaut.
